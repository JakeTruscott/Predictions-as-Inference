...
sandbox_data <- data.frame(
  ...
  var6 = sample(0:50, 1000, replace = TRUE))

pai_function <- function(data, #Data
...
pai_test <- pai_function(data = sandbox_data,
            model = 'parRF',
            outcome = 'var1',
            predictors = NULL,
...
knitr::include_graphics("C:/Users/Jake Truscott/Desktop/output.png")
```
...
plot(pai_diagnostic_retrieval(output = pai_test, 
                         diagnostic = 'placebo', 
                         type = 'figure'))
...
pai_diagnostic_retrieval(output = pai_test, 
                         ...
                         type = 'figure', 
                         combine_plots = T, 
                         variables = c('var2', 'var4'))

```

##### **Bootstrap Confidence Intervals**

###### **Var-Level Confidence Intervals**
...
###### **Density of Bootstrap Accuracies**
